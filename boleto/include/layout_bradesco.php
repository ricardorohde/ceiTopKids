...
<table width=666 cellspacing=0 cellpadding=0 border=0><tr><td valign=top class=cp><DIV ALIGN="CENTER"><br/>
<input type="button" name="imprimir" value="Imprimir" onClick="window.print();"><br/></DIV></TD></TR><TR><TD valign=top class=cp><DIV ALIGN="left">
<p>
...
<table width=666 cellspacing=5 cellpadding=0 border=0 align=Default>
  <tr>
    <td width=41><IMG SRC="<?php echo 'imagens/'.$logo; ?>" width="147" height="46" ></td>
...
<table cellspacing=0 cellpadding=0 border=0>
  <tbody>
    ...
    <tr>
      <td  width=7 ></td>
      <td class=cp width=564 ><span class="campo"> <?php echo $dadosboleto["demonstrativo1"]?> </span></td>
      <td  width=7 ></td>
      <td  width=88 ></td>
    </tr>
  </tbody>
