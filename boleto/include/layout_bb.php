...
.dt{color:navy; font-size:11px;font-family: 'Arial Narrow';}
		...
		<tr><td class="last_line" rowspan="6">
			...
			<tr class="campos">
				<td class="instrucoes" rowspan="5">		
                    ...
                    <p><span class="dt">Detalhes da fatura:</span></p>
