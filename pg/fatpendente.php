...
<div id="entrada">
    ...
    <form name="form" action="php/delfat.php" method="post" enctype="multipart/form-data" onsubmit="return excluir(this);">
        ...
        if (isset($_POST['pesquizar']) && $_POST['pesquizar'] != "") {
            ...
            $sql_1 = "SELECT * ,date_format(data_venci, '%d/%m/%Y') AS data FROM faturas WHERE situacao ='P' ORDER BY data_venci ASC";
        }
...
//                            }
                        ...
                        <td align="center" valign="middle">
                            <a href="php/reenviarmail.php?id_venda=<?php echo $array['id_venda'] ?>&idcliente=<?php echo $array['id_cliente'] ?><?php echo $vari ?>">
                        ...
                        <td width="36" align="center">
                            <div id="editar">
                                <a href="pg/editafatura.php?id_venda=<?php echo $array['id_venda'] ?>" class="editar" title="Editar dados"  
                                   onclick="NovaJanela(this.href, 'nomeJanela', '650', '450', 'yes');
                                               return false">Editar</a></span>
                            </div></td>
                        ...
                        <td width="50" align="center"><div id="baixar">
                                ...
                                if (isset($_GET['p'])) {
                                    ...
                                    $pg = $_GET['p'];
                                    ?>
                                    <a href="pg/baixamanual.php?id_venda=<?php echo $array['id_venda']; ?>" class="editar" title="Receber título" onclick="NovaJanela(this.href, 'nomeJanela', '650', '450', 'yes');
                                                    return false">Baixar</a>
                                   <?php } else { ?>
                                    <a href="pg/baixamanual.php?id_venda=<?php echo $array['id_venda']; ?>&pagina=fatpendente" class="editar" title="Receber título" onclick="NovaJanela(this.href, 'nomeJanela', '650', '450', 'yes');
                                                    return false">Baixar</a> </span>
    <?php } ?>
                            </div></td>
                    </tr>
<?php } ?> 
                <tr>
                    <td colspan="12" bgcolor="#0490fc">
                        ...
                        <?php
                        $sqlsoma = mysql_query("SELECT sum(valor) AS val FROM faturas WHERE situacao ='P'");
...
$sql_select_all = "SELECT * FROM faturas WHERE situacao ='P'";
