...
$vencida = "window.open(\"../inicio.php?pg=fatvencida\",\"main\");";
}else{	
$vencida = "window.open(\"../inicio.php?pg=fatpendente\",\"main\");";	
}
?>	
...
<div id="forms">
  ...
  <br/>
  	Documento:<br/>
    <input name="num_doc" type="text" value="<?php echo $linha['num_doc']?>" onkeypress="return SomenteNumero(event)" style="width:100px;">
